...
public class MortgageCalc {
    ...
    public MortgageCalc(double capital, double interestRate, int quYears, double creditSum, int monthRentPaymentRate) {
    ...
    // Расчитывает ежемесячный ипотечный платёж, сумму всех платежей и переплату по кредиту
    ...
    // Расчитывает размер итогового инвестиционного капитала после окончания срока инвестирования
    ...
    // Расчитывает сумму всех арендных платежей за весь срок аренды
